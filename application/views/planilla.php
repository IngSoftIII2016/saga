<div class="col-md-12 tabla" id="contenido">
    ...
    <div class="row">
        <div class="col-md-3">
            <button type="reset" class="btn col-md-4 btn-primary btn-ant" data-toggle="modal"
                    data-target="#modalInsertarEvento">Evento <i class="fa fa-plus-square" aria-hidden="true"></i>
            </button>
        ...
        <button type="reset" id="reload-ant" class="btn col-md-1 btn-primary btn-ant" style="margin-left: 5%;">Ant
        </button>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-3">
                                <label class="control-label">Hora Inicio</label> <input type="time"
                                                                                        class="form-control"
                                                                                        id="horainicioevento"
                                                                                        name="horainicioevento" required
                                                                                        max="20:00:00"
                            ...
                            <div class='form-group col-md-6'>
                                ...
                                <textarea class="form-control" required name="motivoevento"
                                          id="motivoevento"></textarea>
                            </div>
                            <div class="row">
