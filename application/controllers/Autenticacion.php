...
class Autenticacion extends CI_Controller {
	...
	// Redirigir si es necesario , de lo contrario mostrar la lista de usuarios
	function index()
	{
		...
		if (!$this->ion_auth->logged_in())
		{
			...
			// Redirigirlos a la página de inicio de sesión
			redirect('autenticacion/login', 'refresh');
		}
		elseif (!$this->ion_auth->is_admin()) // Eliminar esta elseif si desea habilitar esto para los no administradores
		{

			// Redirigirlos a la página principal , ya que debe ser un administrador para ver esta
